<template>
	<view class="content">
		<view class="search-box">
			...
			<mSearch :mode="2" button="inside" :placeholder="defaultKeyword" @search="doSearch(false)" @input="inputChange" @confirm="doSearch(false)" v-model="keyword"  class="mSearch"></mSearch>	
		</view>
